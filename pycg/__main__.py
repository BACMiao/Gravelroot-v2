...
def main():
    ...
    parser.add_argument(
        "--name", help="The project name to be analyzed", default=None
    )
    parser.add_argument(
    ...
    cg = CallGraphGenerator(
        args.entry_point, args.sinks, args.package, args.name, args.max_iter, args.operation
    )
    cg.analyze()
    ...
    if args.output:
        output_file = args.output.replace('[P_NAME]', args.name)
